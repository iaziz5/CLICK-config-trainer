      ...
      <div ref={scrollRef} className={`${heightClass} overflow-auto font-mono text-sm leading-relaxed ${theme.bg} ${theme.text} p-4`}>
        {lines.length === 0 ? (
          <div className={`${context==='nodered'?'text-red-400/70':'text-emerald-500/70'} flex items-center gap-2`}>
            <svg style={{width: "16px", height: "16px"}} className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-500/30">
            <svg style={{width: "20px", height: "20px"}} className="w-5 h-5 text-white flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <ol className="text-sm text-gray-700 space-y-2 list-decimal pl-5 max-h-64 overflow-auto">
        {notes.length === 0 ? (
          <div className="text-sm text-gray-500 flex items-center gap-2 py-4">
            <svg style={{width: '20px', height: '20px'}} className="w-5 h-5 text-blue-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
...
function Icon({ name }) {
  ...
  switch (name) {
    case "overview": return (<svg style={iconStyle} viewBox="0 0 24 24" className={common}><path d="M4 6h16M4 12h10M4 18h7" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round"/></svg>);
    case "config": return (<svg style={iconStyle} viewBox="0 0 24 24" className={common}><path d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" stroke="currentColor" strokeWidth="1.5" fill="none"/><circle cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="1.5" fill="none"/></svg>);
    case "send": return (<svg style={iconStyle} viewBox="0 0 24 24" className={common}><path d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/></svg>);
    case "receive": return (<svg style={iconStyle} viewBox="0 0 24 24" className={common}><path d="M20 12H4M4 12l6-6M4 12l6 6" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/></svg>);
    case "nodered": return (<svg style={iconStyle} viewBox="0 0 24 24" className={common}><circle cx="6" cy="12" r="3" stroke="currentColor" strokeWidth="2" fill="none"/><circle cx="18" cy="12" r="3" stroke="currentColor" strokeWidth="2" fill="none"/><path d="M9 12h6" stroke="currentColor" strokeWidth="2"/></svg>);
    case "logs": return (<svg style={iconStyle} viewBox="0 0 24 24" className={common}><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round"/></svg>);
    case "tests": return (<svg style={iconStyle} viewBox="0 0 24 24" className={common}><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/></svg>);
    default: return null;
  }
}
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg shadow-emerald-500/30">
            <svg style={{width: "24px", height: "24px"}} className="w-6 h-6 text-white flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="rounded-2xl border-2 border-emerald-200 p-5 bg-gradient-to-br from-emerald-50 to-teal-50">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 rounded-lg bg-emerald-500 flex items-center justify-center">
              <svg style={{width: "16px", height: "16px"}} className="w-4 h-4 text-white flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  function PanelTests() {
    ...
    return (
      <div className="space-y-5">
        ...
        >
          <span className="flex items-center gap-2">
            <svg style={{width: "20px", height: "20px"}} className="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            Run All Tests
      ...
      <div className="rounded-2xl border-2 border-gray-200 bg-gradient-to-r from-white to-gray-50 p-4 mb-6 flex flex-wrap items-center gap-4 shadow-lg shadow-gray-100/50">
        <div className="flex items-center gap-3">
          ...
          <div className="inline-flex rounded-xl border-2 border-gray-200 overflow-hidden text-sm shadow-sm">
            ...
            >
              <svg viewBox="0 0 24 24" style={{width: "16px", height: "16px"}} className="w-4 h-4 flex-shrink-0" aria-hidden="true">
